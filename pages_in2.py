...
LOCATION = {**_D,
    ...
    "title": "Address & Location QR Code Generator | Google Maps QR India — SmartQRCraft",
    "description": "Make a free QR code for an address or location: type your shop address, paste a Google Maps link or coordinates, and it opens in Maps. PNG or SVG, no signup.",
    "og_title": "Address & Location QR Code Generator | SmartQRCraft India",
    "og_description": "Turn a Google Maps link or coordinates into a QR code that opens directions. Free, no signup.",
    "h1": 'Free <span class="accent">Address &amp; Location QR Code</span> Generator',
    ...
    "sections": [
        ...
        {"kind": "prose", "id": "address",
         "h2": "QR code for an address",
         "p": ["You can also type a plain address, for example <em>Shop 12, MG Road, Bengaluru 560001</em>. The code opens Google Maps and searches for it. Check the result on your own phone: if Maps shows the wrong place, use a Google Maps share link or the exact coordinates instead.",
               "For a shop, office or clinic, the most reliable choice is the <strong>Share</strong> link of your Google Business Profile or the pin you dropped in Maps, because it points at the exact entrance."]},
        {
    ...
    "faq": [
        ("Can I make a QR code for my address?",
         "Yes. Type the full address, paste a Google Maps link, or enter coordinates. Scanning opens the location in Maps."),
