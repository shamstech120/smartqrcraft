...
(function () {
  ...
  function footerHTML(base) {
    ...
    return (
      ...
      /*TOOLLINKS*/
      '<li><a href="' + base + 'qr-code-scanner-online.html">QR-Code Scanner</a></li>' +
      '<li><a href="' + base + 'qr-code-testen.html">QR-Code testen</a></li>' +
      '<li><a href="' + base + 'barcode-generator-kostenlos.html">Barcode erstellen</a></li>' +
      '<li><a href="' + base + 'wlan-qr-code-generator.html">WLAN QR-Code</a></li>' +
      '<li><a href="' + base + 'visitenkarte-qr-code-generator.html">QR-Code Visitenkarte</a></li>' +
      '<li><a href="' + base + 'qr-code-ueberweisung-erstellen.html">QR-Code Überweisung</a></li>' +
      '<li><a href="' + base + 'qr-code-mit-logo.html">QR-Code mit Logo</a></li>' +
      '<li><a href="' + base + 'pdf-in-qr-code.html">PDF in QR-Code</a></li>' +
