/*! SmartQRCraft — minimal ZIP writer (store, no compression). window.SmartZip.build(files) -> Blob
 * files: [{ name: "a.png", data: Uint8Array }] */
(function (global) {
  "use strict";
  var TABLE = (function () {
  ...
  global.SmartZip = { build: build, crc32: crc32, utf8: utf8 };
